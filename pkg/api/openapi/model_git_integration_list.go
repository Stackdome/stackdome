...
// NewGitIntegrationList instantiates a new GitIntegrationList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGitIntegrationList() *GitIntegrationList {
	this := GitIntegrationList{}
	return &this
}

// NewGitIntegrationListWithDefaults instantiates a new GitIntegrationList object
...
type NullableGitIntegrationList struct {
	value *GitIntegrationList
	isSet bool
}

func (v NullableGitIntegrationList) Get() *GitIntegrationList {
	return v.value
}

func (v *NullableGitIntegrationList) Set(val *GitIntegrationList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGitIntegrationList(val *GitIntegrationList) *NullableGitIntegrationList {
	return &NullableGitIntegrationList{value: val, isSet: true}
}
