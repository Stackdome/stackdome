      ...
      {panels.map(({ entry, title, icon }, i) => {
        ...
        return (
          <aside
            ...
            className={cn(
              "fixed flex w-[680px] max-w-[calc(100vw-24px)] flex-col overflow-hidden rounded-lg border border-border bg-background animate-in slide-in-from-right-8 fade-in duration-[260ms]",
